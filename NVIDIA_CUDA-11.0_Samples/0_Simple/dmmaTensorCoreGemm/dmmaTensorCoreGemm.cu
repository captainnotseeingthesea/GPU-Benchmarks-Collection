...
enum kernels
{
    ...
    dmma_shmem_gemm             = 1, // DMMA shmem using kernel normal copy (without async_copy).
    simple_dmma_gemm            = 2  // DMMA non-shmem using simple kernel.
};

const char* kernelNames[] = {"compute_dgemm_async_copy", "compute_dgemm", 
                            "simple_wmma_gemm"};
